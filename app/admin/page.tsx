...
import { Plus, Book, Trash2, ChevronRight } from "lucide-react"
            ...
            <div key={grade.id} className="glass-card group flex flex-col">
              ...
              <div className="flex flex-col gap-2 border-t border-border bg-secondary/30 p-4">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <button className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-red-500/10 p-2.5 text-sm font-bold text-red-500 transition-all hover:bg-red-500 hover:text-white">
